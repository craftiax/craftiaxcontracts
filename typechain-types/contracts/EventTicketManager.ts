...
export interface EventTicketManagerInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface EventTicketManager extends BaseContract {
  connect(runner?: ContractRunner | null): EventTicketManager;
  waitForDeployment(): Promise<this>;

  interface: EventTicketManagerInterface;
  ...
  mintTicket: TypedContractMethod<
    [eventId: string, tierId: string, recipient: AddressLike],
    [void],
    "payable"
  >;
